package("nativefiledialog-extended")
    ...
    add_deps("cmake")
    if is_plat("windows") or is_subhost("msys") then
        add_syslinks("shell32", "ole32", "comctl32", "oleaut32", "uuid")
    ...
    on_install("windows", "macosx", "linux", "mingw", "msys", function (package)
        ...
        if is_subhost("msys") then
            table.insert(configs, "-DCMAKE_C_FLAGS=-D__MINGW32__=1")
            table.insert(configs, "-DCMAKE_CXX_FLAGS=-D__MINGW32__=1")
        end
