package("capstone")
    ...
    add_urls("https://github.com/aquynh/capstone/archive/$(version).tar.gz", {alias = "github-archive"})
    add_urls("https://github.com/capstone-engine/capstone.git", {alias = "git-github"})

    add_versions("github-archive:4.0.2", "7c81d798022f81e7507f1a60d6817f63aa76e489aa4e7055255f21a22f5e526a")
    add_versions("github-archive:5.0.1", "2b9c66915923fdc42e0e32e2a9d7d83d3534a45bb235e163a70047951890c01a")
